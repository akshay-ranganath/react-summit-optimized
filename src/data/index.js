export const base_url =
  "https://res.cloudinary.com/dbmataac4/image/upload/workshop/";
//http://react-workshop.mo.cloudinary.net/images/ MO base_URL
//https://res.cloudinary.com/dbmataac4/image/upload/workshop/ Origin base_url
export const banner_url =
  "https://res.cloudinary.com/dbmataac4/image/upload/w_1600,h_460,c_pad,f_auto,q_auto/workshop/";

export const data = {
  banner: [
    {
      to: "/link",
      img: banner_url + "cldnry_fashion_pdp_basic_tee6.jpg",
  ...
  products: [
    {
      ...
      img: base_url + "cldnry_fashion_pdp_basic_tee6.jpg",
      price: 180,
      originPrice: 200,
      discountPrice: 20,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: base_url + "cldnry_fashion_pdp_basic_tee5.jpg",
      price: 475,
      originPrice: 0,
      discountPrice: 0,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: base_url + "cldnry_fashion_pdp_basic_tee4.jpg",
      price: 1900,
      originPrice: 2000,
      discountPrice: 100,
      discountPercentage: 0,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: base_url + "cldnry_fashion_pdp_basic_tee1.jpg",
      price: 10,
      originPrice: 0,
      discountPrice: 0,
      discountPercentage: 0,
    ...
    },
    {
      ...
      star: 3,
      isFreeShipping: false,
      description: "Best Book ever | Winner of awards | Soon to be a movie!",
    },
  ],
  blogBanner: [
    {
